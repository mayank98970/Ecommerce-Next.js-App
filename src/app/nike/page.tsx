...
const nikeProducts: Product[] = [
  {
    ...
    price: 120,
    image: "/products/nike1.jpeg",
  },
  {
    id: 2,
    name: "Nike Revolution 5",
    price: 95,
    image: "/products/nike 2.jpeg",
  },
  {
    id: 3,
    name: "Nike Downshifter 11",
    price: 85,
    image: "/products/nike 3.jpeg",
  },
  {
    id: 4,
    name: "Nike Court Vision Low",
    price: 110,
    image: "/products/nike 4.jpeg",
  },
  {
    id: 5,
    name: "Nike Air Force 1",
    price: 130,
    image: "/products/nike 5.jpeg",
  },
  {
    id: 6,
    name: "Nike Blazer Mid '77",
    price: 125,
    image: "/products/nike 6.jpeg",
  },
];
...
export default function NikePage() {
  ...
  return (
    <div className="min-h-screen bg-white py-8 px-2 sm:px-4">
      <h1 className="text-2xl sm:text-3xl font-bold mb-8 text-gray-900 text-center">Nike Sneakers</h1>
